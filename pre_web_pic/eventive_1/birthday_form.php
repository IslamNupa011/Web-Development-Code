...
<html>
    <head>
        <title>Bd_Event_management_form</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div id="middle_birthday">
            ...
            <h1 style="text-align: center;color:white;">Birthday Event Management Form</h1>
              </div>
            ...
            <div id="form2">
             <form method="post" action="">
				...
				<input type="checkbox" name="stage1" value="stage2"><b>Stage</b>
                <input type="checkbox" name="cake" value="cake1"><b>Cake</b>
                
                <input type="checkbox" name="photography1" value="photo2"><b>Photography</b><br/><br/>
				 </form> 
