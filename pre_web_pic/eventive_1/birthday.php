...
<html>
    <head>
        <title>Bd_Event_management</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div id="middle_birthday">
            <img src="picture\bd_cover.jpg" alt="weed_err" style="width:100%; height:700px" >
            
             <div style="background-color: #FB6161;display:inline-block;width:100%;height:50%;">
            <h1 style="text-align: center;color:white;"><a href="#" style="text-decoration:none;">Birthday Event Management</a></h1>
              </div>
            ...
            <!--choose option-->
             ...
             <div>
                 ...
                 <span  >Birthday Stage Decoration<br/><img src="picture\bd_decor.jpg" alt="1img">
                 </span>
                 
                
                <div> <span >Birthday cake Decoration<br/><img src="picture\bd_cake.jpg" alt="cimg">
               
                    </span></div>
                 
                  
                <!--<div> <span >Wedding Venue Lighting<br/><img src="picture\venue_light.jpg" alt="vlight">
           </span></div>
                 
                <div> <span >Holud Decoration<br/><img src="picture\holud_pic.jpg" alt="hpic">
               
                    </span></div>-->
                 
                 <div> <span >Birthday Photography<br/><img src="picture\bd_photo1.jpg" alt="ppic">
