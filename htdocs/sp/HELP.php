	...
	<!--navigation bar section-->
		...
		<div class= "sideber col-sm-3">
             ...
             <div class= "nav">
                ...
                <h4><a href="Client_result.php"> OUR CLIENTS </a></h4>
                <h4><a href="Carrer.php"> CAREER </a></h4>
		</div>	
     </div>
	 ...
	 <div class="main col-sm-9">
			 ...
			 <h4> <b> Syncdocs Help </b> </h4>
			 <p> Look for help in the frequently asked questions (FAQ).  </p>
			 <p> If you can’t find what you’re looking for, then please ask on the forums</p> <br> <br>
				 
			 <h4> <b> Customize Search </b> </h4>	 
